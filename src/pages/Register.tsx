...
import { Mail, Lock, Eye, EyeOff, ArrowRight, ArrowLeft, CheckCircle2, Phone, User } from 'lucide-react';
    ...
    <div className="auth-container">
      ...
      <aside className="auth-sidebar">
        ...
        <div className="sidebar-content">
          <h1 className="sidebar-title">Bizning oilamizga qo'shiling.</h1>
      ...
      <main className="auth-main">``
        ...
        <div className="form-wrapper">
          <h2 className="form-title">Yangi hisob yarating</h2>
          <p className="form-subtitle">Ma'lumotlaringizni kiriting va bepul ro'yxatdan o'ting.</p>

          <form className="auth-form" onSubmit={(e) => e.preventDefault()}>
            
            <div className="input-row">
              <div className="input-group">
                <label className="input-label">Ism <span className="required-asterisk">*</span></label>
                <div className="input-wrapper">
                  <User className="input-icon left" />
                  <input type="text" placeholder="Aziz" className="input-field has-left-icon" required />
                </div>
              </div>
              <div className="input-group">
                <label className="input-label">Familiya <span className="required-asterisk">*</span></label>
                <div className="input-wrapper">
                  <User className="input-icon left" />
                  <input type="text" placeholder="Komilov" className="input-field has-left-icon" required />
                </div>
              </div>
            </div>
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                ...
                <input type="email" placeholder="Aziz@gmail.com" className="input-field has-left-icon" required />
              </div>
            </div>
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                ...
                <input type="tel" placeholder="+998" className="input-field has-left-icon" required />
              </div>
            </div>

            <div className="input-group">
              <label className="input-label">Parol <span className="required-asterisk">*</span></label>
              <div className="input-wrapper">
            ...
            <div className="input-group">
              <label className="input-label">Parolni tasdiqlang <span className="required-asterisk">*</span></label>
              <div className="input-wrapper">
                <Lock className="input-icon left" />
                <input 
            ...
            <label className="checkbox-group">
              ...
              <span>
                <a href="#">Foydalanish shartlari</a> va <a href="#">Maxfiylik siyosati</a>ga roziman
              </span>
            </label>
